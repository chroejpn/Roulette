...
const translations = {
    ja: {
        ...
        saveBtn: "現在の項目を保存",
        titleEdit: "項目の編集",
        descEdit: "「項目名:割合」で重みを設定できます（例: A:1）<br>割合を省略した場合は「1」として扱われます．改行で区切ってください．",
        updateBtn: "ルーレットを更新",
        spinBtn: "回す！",
        resultPrefix: "結果: ",
    ...
    en: {
        ...
        descEdit: "Set weights with 'Name:Weight' (e.g. A:1)<br>If omitted, it defaults to 1. Separate items by newlines.",
